...
from src.data.pipelines.download.graphs import _SPECTRE_DATASET_NAME_TO_FILENAME, _PICKLED_DATASET_NAME_TO_FILENAME
...
@reg_preprocess.register({
    'community-20-spectre': {'dataset_name': 'community-20'},
    'planar-spectre': {'dataset_name': 'planar'},
    'sbm-spectre': {'dataset_name': 'sbm'},
})
class SpectreDatasetPreprocessingPipeline:
    ...
    def __repr__(self):
        return f'SpectreDatasetPreprocessingPipeline({self.dataset_name})'
...
@reg_preprocess.register({
    'community-small': {'dataset_name': 'community-small'},
    'ego-small': {'dataset_name': 'ego-small'},
    'enzymes': {'dataset_name': 'enzymes'},
    'ego': {'dataset_name': 'ego'},
    'grid': {'dataset_name': 'grid'}
})
class PickledDatasetPreprocessingPipeline:
    ...
    def __repr__(self):
        return f'PickledDatasetPreprocessingPipeline({self.dataset_name})'
