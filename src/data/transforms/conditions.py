...
class CondMaxNumberOfAtoms(Condition):
    def __init__(
            self,
            obj_to_check_df: str,
            max_number_of_atoms: None
        ):
    ...
    def __call__(self, data: Dict) -> bool:
        ...
        if self.max_number_of_atoms is None:
            return True
        else:
            return elem_to_check.GetNumAtoms() <= self.max_number_of_atoms
