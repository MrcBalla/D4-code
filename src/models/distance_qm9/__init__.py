...
from src.models.distance_qm9.losses.train_denoising import TrainLoss_distance
...
from src.models.architectures.gnn.distance_graph_transformer_qm9 import distance_GraphTransformer_qm9
from src.noise.graph_diffusion_distance import DiscreteUniformDiffusionProcess_distance

from src.models.distance_qm9 import labels
...
@reg_models.register()
class DistanceDenoisingDiffusionModel_qm9(Generator):
    ...
    def __init__(
        ...
        self.data_dims = {
            ...
            "c": 3,
            "dist": 1,
            'eigen': dataset_info['num_nodes_max']
        }
